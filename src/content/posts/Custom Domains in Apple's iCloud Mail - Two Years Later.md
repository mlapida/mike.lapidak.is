...
type: post
status: published
title: "Custom Domains in Apple's iCloud Mail: Two Years Later"
...
Over the past two years, outside of iCloud Mail, I've spent the majority of the time on [Microsoft 365](https://www.office.com/) 's Exchange offering. The price is approachable, it's infinitely customizable, and search, spam, and the web app are all market leading.
...
![](/post-images/custom-domains-in-apples-icloud-mail-two-years-later/CleanShot-2023-08-02-at-21.28.01@2x.png)

A screenshot of Cloudflare's email forwarding, complete with Apple Mail SPF delivery failures

In the two years since launch, the web interface has received a face lift with proper drag-and-drop, nested conversations, a better home screen, and more. It's a bit faster, though nowhere near the others. I've also come to appreciate the [rather aggressive message filtering](https://support.apple.com/en-us/HT204137), which requires a sender to properly configure their [SPF records](https://www.cloudflare.com/learning/dns/dns-records/dns-spf-record/) for a message to get through. (Have you ever received a spam message from your email address, with someone claiming to have hacked your account?)

Beyond the improvements to the web, Apple [added BIMI support](https://support.apple.com/en-us/HT213155?cid=mc-ols-icloudmail-article_ht213155-ios_ui-03082022) to verify senders from large organizations. This works across the web, mobile, and desktops and is a great way to fight phishing attempts.
...
Finally, the value of the service really can't be overstated. If you subscribe to any paid [iCloud plan](https://support.apple.com/en-us/HT201238), you can use up to five unique domains, and each family member can have up to three email addresses per-domain. This ends up making iCloud Mail a fraction of the price of every other service out there, especially when including family members.
