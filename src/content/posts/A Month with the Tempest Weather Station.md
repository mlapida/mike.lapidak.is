...
After installing the Tempest, I set up the base station and the app, and the data began flowing in. Over the following days, I moved the Tempest from one post to another, looking for the most accurate wind speed away from structures and trees.
